...
def get_num_fresh_IDs(fresh_ranges):
    num_fresh_IDs = len(fresh_ranges)
    
    for current_range in fresh_ranges:
        num_fresh_IDs += current_range[1] - current_range[0]
...
if __name__ == "__main__":
    ...
    print(get_num_fresh_IDs(optimised_fresh_ranges))
